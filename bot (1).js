...
client.on('ready', () => {
     client.user.setActivity(`GF Community I 0.5`,'https://www.twitch.tv/v5bz');
...
client.on('message', msg => {
  if (msg.content === '-inv') {
    msg.reply(', https://discordapp.com/api/oauth2/authorize?client_id=478535669346730008&permissions=8&redirect_uri=https%3A%2F%2Fwww.facebook.com%2Fomartetohhh&scope=bot');
  }
});
...
client.login('NDgxMTA2NjQ4OTA4MTY5MjE2.DlxhZg.nRwAtqnJt6jqFQpCc-gpno5Ad3M')


client.on('guildCreate', guild => {
  client.channels.get("480340048282124288").send(`:white_check_mark: **تم اضافة البوت في سيرفر جديد مبروكك
...
client.on('guildDelete', guild => {
  client.channels.get("480340048282124288").send(`:negative_squared_cross_mark: **طردوني حرام والله ايش سويت انا
Server name: __${guild.name}__
Server owner: __${guild.owner}__
Server id: __${guild.id}__ 
Server Count: __${guild.memberCount}__**`)
...
.addField('مصمم  + صاحب البوت ',`IIMaco#7991`)
.setColor('#7d2dbe')
...
client.on('guildMemberAdd', member => {
    ...
    client.channels.get('480341362038931466').setName(`⟫『 ${memberCount} عدد الاعضاء 』⟪`);
    client.channels.get('480341506062942208').setName(`⟫『 ${botCount} عدد البوتات 』⟪`);
});
...
client.on('message', msg => {
  ...
  let args = msg.content.split(" ").slice(1);
    ...
    if (textxt == "") {
        msg.delete().then
    msg.channel.send("***```ضع عدد الرسائل الذي تريد مسحها ليست اكثر من 100```***").then(m => m.delete(100));
} else {
    msg.delete().then
    msg.delete().then
...
client.on('message', message => {
 ...
 message.author.sendMessage(`
**
Bot BY IIMaco#7991 And hamodii_yt#8531
             TWEETY       BOT
╔[❖════════════❖]╗
             Prefix = ' - '
╚[❖════════════❖]╝
...
bot invite link: https://discordapp.com/oauth2/authorize?client_id=478535669346730008&permissions=8&redirect_uri=https%3A%2F%2Fwww.facebook.com%2Fomartetohhh&scope=bot
...
client.on('message', message => {
  ...
  const embed = new Discord.RichEmbed()
  .setTitle('Click here')
  .setURL('https://discord.gg/t4Cmp7X')
  .setColor('RANDOM')
  message.channel.send({embed: embed});
  }
});
